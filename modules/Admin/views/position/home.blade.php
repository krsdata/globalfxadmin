                            ...
                            <div class="portlet light portlet-fit bordered">
                                     ...
                                     <div class="col-md-2 pull-right">
                                            <div style="width: 150px;" class="input-group"> 
                                                <a href="{{ route('position.create')}}">
                                                    <button  class="btn btn-success"><i class="fa fa-plus-circle"></i> Create Position</button> 
                                                </a>
                                            </div>
                                        </div> 
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <form action="{{route('position')}}" method="get" id="filter_data">
                                         ...
                                         <div class="col-md-2">
                                             <a href="{{ route('position') }}">   <input type="submit" value="Reset" class="btn btn-default form-control"> </a>
                                        </div>
