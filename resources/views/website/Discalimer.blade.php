...
<div class="bannertxt">
<h1>DIS<span>CLAIMER</span></h1></div>
</div>
...
<section class="howworks">
  <div class="container">
    <div class="row">
     <div class="col-lg-12">
       <h2 class="mb-3">DIS<span>CLAIMER</span></h2>
       <div class="text-left ">
     <div class="heading-section">
            <h2 class="heading line"> JUSTKHELO FANTASY CRICKET <span> DISCLAIMER</span></h2>
           </div> 
           <div class="paragraph-Pp">
            <p>As permitted by law, neither JUSTKHELO nor its parent/holding company, subsidiaries, affiliates, directors, officers, professional advisors, or employees shall be responsible for the deletion, the failure to store, the misdelivery, or untimely delivery of any information.</p>
