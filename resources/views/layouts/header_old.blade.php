...
<html lang="en">
  <head>
    <title>{{env('company_name')}} | JustKheloFantasy App</title>
    <meta charset="utf-8"> 
...
ninja 11 app download, JustKheloapp, ninja 11 fantasy app ,ninja 11 fantasy app download, ninja 11, Fantasy App, Best Fantasy App, Cricket, cricket Fantasy, Fantasy, Fantasy app 100% bonus used, Instant withdrawal, No KYC Fantasy App, Most popular fantasy app">
    ...
    <script type="application/ld+json">
      ...
      "mainEntity": [{
        ...
        {
          "@type": "Question",
          "name": "Is JustKhelosafe and legal in India?",
          "acceptedAnswer": {
            "@type": "Answer",
